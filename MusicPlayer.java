...
public class MusicPlayer extends PlaybackListener {
    ...
    public void playCurrentSong(){
        ...
        try{
            ...
            if(!file.exists()) {
                // If file not found at exact path, try looking in src/assets
                if(!filePath.startsWith("src/assets/")) {
                    file = new File("src/assets/" + new File(filePath).getName());
                }
                // If still not found, try just assets/
                if(!file.exists() && filePath.startsWith("src/assets/")) {
                    file = new File("assets/" + new File(filePath).getName());
                }
            }
            ...
            if(!file.exists()) {
                ...
                System.err.println("  - " + new File("src/assets/" + new File(filePath).getName()).getAbsolutePath());
                System.err.println("  - " + new File("assets/" + new File(filePath).getName()).getAbsolutePath());
                return;
            }
            ...
            System.err.println("Error playing " + currentSong.getFilePath() + ": " + e.getMessage());
            e.printStackTrace();
        }
    }
